...
import { generateGraphNodesEndpoint, GraphNodeJSON } from "~/lib/common/app/graph/endpoints";
...
export class GraphNodeApi<T extends GraphNodeJSON | NodeJSON = NodeJSON> extends EntityApiService<
	T,
	GraphNodeCreateDto,
	GraphNodeUpdateDto
> {
